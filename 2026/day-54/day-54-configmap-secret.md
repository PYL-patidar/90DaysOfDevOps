...
- Environment Variables:  
ConfigMap or Secret values are injected as environment variables inside the container. These values do not update automatically if the ConfigMap or Secret changes.  
- Volume Mounts:
